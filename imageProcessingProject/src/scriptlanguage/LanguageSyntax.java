...
public interface LanguageSyntax {
  ...
  /**
   * Updates the default image of this syntax - the image to be edited if no image is specified by a
   * given input line.
   *
  ...
  /**
   * Updates the default layer of this syntax - the layer to be edited if no image is specified by a
   * given input line.
   *
